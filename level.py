  ...
  def read_tiles(self):
    ...
    while not at_end:
      ...
      for i in range(5):
        ...
        if tile["id"] == 1:
            tile_image = dirname + "/Tiles/Grass_0.png"
        elif tile["id"] == 2:
            tile_image = dirname + "/Tiles/Grass_1.png"
        elif tile["id"] == 3:
            tile_image = dirname + "/Tiles/Grass_2.png"
        elif tile["id"] == 4:
            tile_image = dirname + "/Tiles/Grass_3.png"
        elif tile["id"] == 5:
            tile_image = dirname + "/Tiles/Grass_4.png"
        elif tile["id"] == 6:
            tile_image = dirname + "/Tiles/Grass_5.png"
        elif tile["id"] == 7:
            tile_image = dirname + "/Tiles/Grass_6.png"
        elif tile["id"] == 8:
            tile_image = dirname + "/Tiles/Grass_7.png"
        elif tile["id"] == 9:
            tile_image = dirname + "/Tiles/Grass_8.png"
        elif tile["id"] == 10:
            tile_image = dirname + "/Tiles/Grass_9.png"
        elif tile["id"] == 11:
            tile_image = dirname + "/Tiles/Grass_10.png"
        elif tile["id"] == 12:
            tile_image = dirname + "/Tiles/Grass_11.png"
        elif tile["id"] == 13:
            tile_image = dirname + "/Tiles/Grass_12.png"
        elif tile["id"] == 14:
            tile_image = dirname + "/Tiles/Pipe_1.png"
        elif tile["id"] == 15:
            tile_image = dirname + "/Tiles/Pipe_2.png"
        elif tile["id"] == 16:
            tile_image = dirname + "/Tiles/Pipe_3.png"
        elif tile["id"] == 17:
            tile_image = dirname + "/Tiles/Pipe_4.png"
        elif tile["id"] == 18:
            tile_image = dirname + "/Tiles/Stone.png"
        elif tile["id"] == 19:
            tile_image = dirname + "/Tiles/barrier.png"
